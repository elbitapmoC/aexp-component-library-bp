...
export const Default: Story = {
  args: {
    ...
    children: <p>This is a light scenario(modal) with medium size. Customize as needed!</p>,
    variant: 'light',
    size: 'medium',
...
export const DarkLarge: Story = {
  args: {
    ...
    children: <p>This is a dark scenario(modal) with large size. Customize as needed!</p>,
    variant: 'dark',
    size: 'large',
    disableBackdropClick: false,
  },
